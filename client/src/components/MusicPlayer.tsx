  ...
  return (
    <div className="fixed bottom-6 right-6 z-[50]">
      <Button
        ...
        size="icon"
        onClick={toggleMusic}
        className="rounded-full bg-black/40 backdrop-blur-md border-white/20 text-white hover:bg-white/10 w-12 h-12 shadow-lg hover:scale-105 transition-transform"
